    ...
    if msg[0] == "st!help":
        ...
        if len(msg) == 1:
            ...
            if len(msg) == 3:
                ...
                if steamid == 0:
                    await app.send_message(message.channel, "Use actual steam id.")
                    return
                ...
                if recents['response']['total_count'] == 0:
                    await app.send_message(message.channel, 'You didn\'t played any game in last 2 weeks or your steam profile is private.')
                    return
